                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(
                        ...
                        icon: Icon(
                          Icons.home,
                          color: _paginaSelecionada == Paginas.HOME
                              ? Colors.red
                              : Colors.grey,
                        ),
                      )),
                      Expanded(
                        ...
                        icon: Icon(
                          Icons.rss_feed,
                          color: _paginaSelecionada == Paginas.FEED
                              ? Colors.red
                              : Colors.grey,
                        ),
                      )),
                      Expanded(
                        ...
                        color: _paginaSelecionada == Paginas.NOTFIC
                            ? Colors.red
                            : Colors.grey,
                      )),
                      Expanded(
                        ...
                        color: _paginaSelecionada == Paginas.PERFIL
                            ? Colors.red
                            : Colors.grey,
                      )),
                    ],
            ...
            children: <Widget>[
              Stack(
                children: <Widget>[
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 90.0, right: 60.0),
                    child: Container(
                ...
                child: GridView.builder(
                    ...
                    itemBuilder: (_,index){
                      return Padding(
                        ...
                        child:  Image.asset('imagens/mulher.jpg', width: double.infinity, fit: BoxFit.fill,),
                      );
                    })
              )
            ],
